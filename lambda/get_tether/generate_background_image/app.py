...
mind_tether_core_path = environ['MIND_TETHER_CORE_PATH']
asset_bucket = environ['TETHER_ASSETS']
...
def add_day_to_background(background_image: Image, width:int, height:int, day: str, max_screen_height_percent: int, day_vertical_start_percent: int):
    max_text_height = height - (height * max_screen_height_percent/100)
    max_text_width = width - 20
    text_vertical_start = height * day_vertical_start_percent/100
    ...
    font_file = f"{mind_tether_core_path}/fonts/{font_config.FILE}"
